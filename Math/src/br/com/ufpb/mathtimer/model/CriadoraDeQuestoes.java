...
//				new Alternativa(4, "D"));
		...
		adicionarAlternativas(q[11], new Alternativa(4, "-11"), new Alternativa(
		...
		adicionarAlternativas(q[19], new Alternativa(2, "-5"), new Alternativa(
				1, "-12"), new Alternativa(2, "-5"), new Alternativa(3, "-11"),
				new Alternativa(4, "-10"));
...
//				1, "Paulo"), new Alternativa(2, "Juca"));
		...
		q[23] = new Questao("Resolva: -3+7");
		adicionarAlternativas(q[23], new Alternativa(1, "4"), new Alternativa(
				1, "4"), new Alternativa(2, "3"), new Alternativa(3, "-4"),
				new Alternativa(4, "-3"));
